...
4. The lesson should present one section for each topic. The section name is the name of the topic. 
5. You can add subheadings to the section if needed. Add depth using the extra material in the references.
6. The produced text should be in Markdown format with embedded LaTeX equations.
7. Do not use tables in the summary.
8. In addition to the aforementioned parts corresponding to the topics, add also a Section for the exercises and the bibliography.